...
# Returns false if no file exists, or returns the loaded file. 
def open_json(path):
...
# Returns False if the file doesn't exist, however 
# it returns None upon successfuly saving. 
...
# Returns Nothing, However saves the player's data. 
...
# Returns the tuple of loaded player data. 
